...
st.subheader(f"Welcome to the {st.session_state.app_name}!")
st.markdown(f"#### What is the ***{st.session_state.app_name}***?")
st.write(f"The ***{st.session_state.app_name}*** is a tool for prospective college students in the United States.")
...
st.markdown(f"#### Overview of the Data used in the ***{st.session_state.app_name}***")
st.markdown(f"* The ***{st.session_state.app_name}*** uses the data from [College Scorecard](https://collegescorecard.ed.gov/data/) and [Opportunity Insights](https://opportunityinsights.org/data/)")
